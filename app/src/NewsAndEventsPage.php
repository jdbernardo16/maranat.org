...
namespace {
	...
	class NewsAndEventsPage extends Page {
		...
		private static $defaults = array(
			'PageName' => 'NewsAndEvents Page',
			'MenuTitle' => 'NewsAndEvents',
			'ShowInMenus' => true,
			'ShowInSearch' => true,
		);
		...
		public function getCMSFields() {
			...
			*/
			...
			// $uploadf->setFolderName('NewsAndEventspage/frame-1');

			return $fields;
		}
	}

	class NewsAndEventsPageController extends PageController {

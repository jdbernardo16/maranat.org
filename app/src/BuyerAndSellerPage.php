...
namespace {
	...
	class BuyerAndSellerPage extends Page {
		...
		private static $defaults = array(
			'PageName' => 'BuyerAndSeller Page',
			'MenuTitle' => 'BuyerAndSeller',
			'ShowInMenus' => true,
			'ShowInSearch' => true,
		);
		...
		public function getCMSFields() {
			...
			*/
			...
			// $uploadf->setFolderName('BuyerAndSellerpage/frame-1');

			return $fields;
		}
	}

	class BuyerAndSellerPageController extends PageController {

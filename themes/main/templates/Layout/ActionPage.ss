<section class="action-frame1">
	<img class="action-frame1__bg" src="$F1BG.URL" alt="">
	<div class="frm-cntnr">
		<div class="action-frame1__content w-full">
			<h1 class="clr--primary font-black max-w-[1054px] m-auto text-3xl lg:text-6xl tracking-widest text-center leading-relaxed">$Title</h1>
		</div>
	</div>
</section>
	...
	<div class="frm-cntnr max-w-[1140px] px-4 py-20">
		<div class="flex gap-10 lg:gap-[100px] justify-between items-center flex-col lg:flex-row">
			...
			<div class="action-frame2__content text-center w-full lg:w-[458px]">
				<h3 class="font-black text-[#FF9900] text-2xl lg:text-[50px] tracking-widest mb-4 lg:mb-20">$F2Header</h3>
				<h2 class="text-4xl lg:text-[72px] font-black text-[#65B331] tracking-widest mb-4 lg:mb-20">$F2Count</h2>
				<p class="text-base lg:text-2xl">$F2Desc</p>
			</div>
		</div>
	</div>
</section>
	...
	<div class="frm-cntnr max-w-[1140px] py-20 px-4">
		<div class="flex gap-10 lg:gap-[100px] justify-between items-center flex-col lg:flex-row">
			<div class="action-frame2__content text-center w-full lg:w-[458px] order-2 lg:order-1">
				<h3 class="font-black text-[#65B331] text-2xl lg:text-[50px] tracking-widest mb-4 lg:mb-20">$F3Header</h3>
				<h2 class="text-4xl lg:text-[72px] font-black text-[#FF9900] tracking-widest mb-4 lg:mb-20">$F3Count</h2>
...
<section class="action-frame4">
	<div class="frm-cntnr max-w-[1440px] px-4 lg:px-[94px] py-20">
		<img class="w-[447px] lg:absolute lg:top-10 lg:right-10" src="$F4IMG.URL" alt="">
		<div class="flex items-end gap-10 flex-col lg:flex-row">
			<div class="w-full lg:w-9/12">
				<div class="text-center mb-20">
					<h1 class="text-3xl lg:text-[71px] font-black tracking-widest text-white">$F4Header</h1>
				</div>
				<div class="relative">
			...
			<div class="w-full lg:w-3/12 align-bottom lg:text-left text-center">
				<p class="text-base lg:text-xl tracking-widest text-white">$F4Desc</p>
			</div>
		</div>
	</div>
</section>